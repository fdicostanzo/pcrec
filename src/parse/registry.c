...
#define ESC(sel, syn, mod, eng, note, q, ce) \
    {RK_ESC, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), (ce), 0, NULL, NO_PORT, NO_PORT, NULL}
...
#define ESC_SET(sel, syn, mod, eng, note, q, ce, bits, neg) \
    {RK_ESC, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), (ce), 0, NULL, {PORT_SET, false, (neg), (bits), NULL}, {PORT_SET, false, (neg), (bits), NULL}, NULL}
...
#define ESC_CLASS_SCALAR(sel, syn, mod, eng, note, q, ce, lit, afn) \
    {RK_ESC, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), (ce), 0, NULL, {PORT_FN, false, 0, NULL, (afn)}, {PORT_SCALAR, true, (lit), NULL, NULL}, NULL}
...
#define ESC_CLASS_INVALID(sel, syn, mod, eng, note, q, ce) \
    {RK_ESC, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, RF_CLASS_INVALID, (note), ROADMAP_PLANNED, (q), (ce), 0, NULL, NO_PORT, NO_PORT, NULL}
...
#define ESC_LEXICAL(sel, syn, mod, eng, note, ce) \
    {RK_ESC, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, RF_LEXICAL, (note), ROADMAP_PLANNED, QF_LEXICAL, (ce), 0, NULL, NO_PORT, NO_PORT, NULL}
#define GROUP_LEXICAL(sel, syn, mod, eng, note) \
    {RK_GROUP, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, RF_LEXICAL, (note), ROADMAP_PLANNED, QF_LEXICAL, NULL, 0, NULL, NO_PORT, NO_PORT, NULL}
#define ESC_DIGIT(sel, syn, eng, note, q, ce) \
    {RK_ESC, (sel), NULL, (syn), M_backrefs, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE_OCTAL, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), (ce), 0, NULL, {PORT_FN, false, 0, NULL, pcrec_brport_digit}, {PORT_FN, true, 0, NULL, pcrec_clsport_octal}, NULL}
...
#define ESC_DIGIT_LIT(sel, syn, eng, note, q, ce, lit) \
    {RK_ESC, (sel), NULL, (syn), M_backrefs, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE_OCTAL, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), (ce), 0, NULL, {PORT_FN, false, 0, NULL, pcrec_brport_digit}, {PORT_SCALAR, true, (lit), NULL, NULL}, NULL}
/* (?X -> "(?X...) requires module 'M'" */
#define GROUP(sel, syn, mod, eng, note, q) \
    {RK_GROUP, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), NULL, 0, NULL, NO_PORT, NO_PORT, NULL}
...
#define GROUP_NEVER(sel, syn, mod, eng, note, q) \
    {RK_GROUP, (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_NEVER, (q), NULL, 0, NULL, NO_PORT, NO_PORT, NULL}
...
#define GROUP_OPT(sel, syn, note, q) \
    {RK_GROUP, (sel), NULL, (syn), M_modifiers, FLAV_PCRE2, ANY_ENGINE, RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), NULL, 0, pcrec_registry_option_run_recognise, {PORT_FN, false, 0, NULL, pcrec_modport_optrun}, NO_PORT, NULL}
...
#define GROUP_T(sel, tl, syn, mod, eng, note, q) \
    {RK_GROUP, (sel), (tl), (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_MODULE, NULL, NULL, 0, (note), ROADMAP_PLANNED, (q), NULL, 25, NULL, NO_PORT, NO_PORT, NULL}
...
#define REJECTED_T(kind, sel, tl, syn, msg, note, q, ce) \
    {(kind), (sel), (tl), (syn), 0, NULL, FLAV_PCRE2, 0, RS_REJECTED, RD_FIXED, (msg), NULL, 0, (note), ROADMAP_NEVER, (q), (ce), 25, NULL, NO_PORT, NO_PORT, NULL}
...
#define FIXED(kind, sel, syn, mod, eng, msg, note, q) \
    {(kind), (sel), NULL, (syn), M_##mod, FLAV_PCRE2, (eng), RS_MODULE, RD_FIXED, (msg), NULL, 0, (note), ROADMAP_PLANNED, (q), NULL, 0, NULL, NO_PORT, NO_PORT, NULL}
...
#define REJECTED(kind, sel, syn, msg, note, q) \
    {(kind), (sel), NULL, (syn), 0, NULL, FLAV_PCRE2, 0, RS_REJECTED, RD_FIXED, (msg), NULL, 0, (note), ROADMAP_NEVER, (q), NULL, 0, NULL, NO_PORT, NO_PORT, NULL}
...
#define REJECTED_DELIM(kind, sel, syn, msg, note, q, ce) \
    {(kind), (sel), NULL, (syn), 0, NULL, FLAV_PCRE2, 0, RS_REJECTED, RD_FIXED, (msg), \
     NULL, RF_CLASS_DELIM, (note), ROADMAP_NEVER, (q), (ce), 0, NULL, NO_PORT, NO_PORT, NULL}
...
ESC_SET('s', "\\s", classes, ANY_ENGINE, "any whitespace character", QF_YES, "set 6", pcrec_cls_space_esc, 0),
ESC_SET('S', "\\S", classes, ANY_ENGINE, "any character that is not whitespace", QF_YES, "set 250", pcrec_cls_space_esc, 1),
ESC_SET('w', "\\w", classes, ANY_ENGINE, "any word character (letter, digit or underscore)", QF_YES, "set 63", pcrec_cls_word_esc, 0),
ESC_SET('W', "\\W", classes, ANY_ENGINE, "any character that is not a word character", QF_YES, "set 193", pcrec_cls_word_esc, 1),
ESC_SET('h', "\\h", classes, ANY_ENGINE, "any horizontal whitespace character", QF_YES, "set 3", pcrec_cls_hspace, 0),
ESC_SET('H', "\\H", classes, ANY_ENGINE, "any character that is not horizontal whitespace", QF_YES, "set 253", pcrec_cls_hspace, 1),
...
ESC_SET('v', "\\v", classes, ANY_ENGINE, "any vertical whitespace character (NOT vertical tab; python re disagrees)", QF_YES, "set 5", pcrec_cls_vspace, 0),
ESC_SET('V', "\\V", classes, ANY_ENGINE, "any character that is not vertical whitespace", QF_YES, "set 251", pcrec_cls_vspace, 1),
...
{RK_ESC, 'N', NULL, "\\N", M_classes, FLAV_PCRE2, ANY_ENGINE, RS_MODULE, RD_MODULE, NULL, NULL, RF_CLASS_INVALID, "any character except newline (PCRE2 forbids it inside a class)", ROADMAP_PLANNED, QF_YES, "err 171", 0, NULL, {PORT_SET, false, 1, pcrec_cls_newline, NULL}, NO_PORT, NULL},
...
{RK_ESC, 'N', "{", "\\N{name}", 0, NULL, FLAV_PCRE2, 0, RS_REJECTED, RD_FIXED,
 ...
 ROADMAP_NEVER, QF_NO, "err 137", 25, recognise_N_name_brace, NO_PORT, NO_PORT, NULL},
...
{RK_ESC, 'p', NULL, "\\p{L}", M_unicode_props, FLAV_PCRE2, ANY_ENGINE,
 ...
 0, pcrec_registry_uprops_recognise, NO_PORT, NO_PORT, NULL},
{RK_ESC, 'P', NULL, "\\P{L}", M_unicode_props, FLAV_PCRE2, ANY_ENGINE,
 RS_MODULE, RD_MODULE, NULL, NULL, 0,
...
ESC('o', "\\o{101}", misc, ANY_ENGINE, "character with the given octal code", QF_YES, "char 0x41"),
...
{RK_GROUP, ':', NULL, "(?:...)",
 ...
 "non-capturing group", ROADMAP_NONE, QF_YES, NULL, 0, NULL, NO_PORT, NO_PORT, NULL},
...
{RK_GROUP, '<', NULL, "(?<name>a)", M_named_groups, FLAV_PCRE2, ANY_ENGINE,
 ...
 {PORT_FN, false, 0, NULL, pcrec_ngport_declare}, NO_PORT, NULL},
...
{RK_GROUP, '>', NULL, "(?>...)", M_atomic_groups, FLAV_PCRE2, VM_ONLY,
 ...
 ROADMAP_PLANNED, QF_YES, NULL, 0, NULL,
 {PORT_FN, false, 0, NULL, pcrec_agport_atomic}, NO_PORT, NULL},
...
{RK_CLASSBRACKET, ':', NULL, "[[:alpha:]]",
 ...
 {PORT_FN, false, 0, NULL, pcrec_clsport_posix}, NULL},
