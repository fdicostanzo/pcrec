...
static const RegDef d_def[] = { {DEFK_STR, DEF_ALWAYS, "[0-9]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef D_def[] = { {DEFK_STR, DEF_ALWAYS, "[^0-9]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef s_def[] = { {DEFK_STR, DEF_ALWAYS, "[\\t\\n\\x0b\\f\\r ]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef S_def[] = { {DEFK_STR, DEF_ALWAYS, "[^\\t\\n\\x0b\\f\\r ]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef w_def[] = { {DEFK_STR, DEF_ALWAYS, "[A-Za-z0-9_]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef W_def[] = { {DEFK_STR, DEF_ALWAYS, "[^A-Za-z0-9_]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef h_def[] = { {DEFK_STR, DEF_ALWAYS, "[\\t \\xa0]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
static const RegDef H_def[] = { {DEFK_STR, DEF_ALWAYS, "[^\\t \\xa0]", NULL}, {DEFK_END, DEF_ALWAYS, NULL, NULL} };
...
{RK_ESC, 'N', "{U+", "\\N{U+0041}", M_unicode_props, FLAV_PCRE2, ANY_ENGINE,
 ...
 70, NULL, NO_PORT, NO_PORT, NULL, NULL},
...
{RK_CLASSBRACKET, ':', NULL, "[[:alpha:]]",
 ...
 {PORT_FN, false, 0, NULL, pcrec_clsport_posix}, NULL, NULL},
...
static const RegDef possessive_def[] = {
    {DEFK_BUILDER, DEF_ALWAYS, NULL, pcrec_def_build_atomic},
