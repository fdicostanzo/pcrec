...
static void emit_pattern_comment(StrBuf *sb, const char *pat)
{
    ...
    pcrec_sb_printf(sb, "/* Generated by pcrec (abi %d). Pattern: ",
              PCREC_ARTIFACT_ABI);
    int prev = 0;
                          ...
                          const char *upper, const InfoStamp *st)
{
     ...
     *
     * The current value is `PCREC_ARTIFACT_ABI` (src/core/limits.def). The
     * bump this emitter last took is `26 -> 27`, [EMIT-VERB]'s emitted-
     * comment axis (D112): non-essential prose leaves every default
     * artifact, `-fcomments` restores it, and the essential generated-by
     * line names the abi digit. §6 states it and every predecessor. */
