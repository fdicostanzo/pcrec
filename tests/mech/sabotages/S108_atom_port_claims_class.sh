# S108 (design row S-BR6) — THE MODULE'S ATOM PORT ALSO CLAIMS THE CLASS
# POSITION.
#
...
SAB_ID="S108-atom-port-claims-class"
...
SAB_DOC_FIGURE="PREDICTED: the corpus RED on octal_class.rxt; registry RED on check_class_ports (the FN class-port population moves). Canonical figure owed from run_sabotage_matrix.sh S108."
SAB_COUNT=1
SAB_BEFORE='{PORT_FN, false, 0, NULL, pcrec_brport_digit}, {PORT_FN, true, 0, NULL, pcrec_clsport_octal}}'
SAB_AFTER='{PORT_FN, false, 0, NULL, pcrec_brport_digit}, {PORT_FN, true, 0, NULL, pcrec_brport_digit}}   /* SABOTAGE S108 */'
