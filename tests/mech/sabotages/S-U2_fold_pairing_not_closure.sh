...
SAB_DOC_FIGURE="PREDICTED (§8.2): every three-member-class cell in tests/utf8/fold.rxt and axis06_caseless_fold.rxt goes red; two-member classes are untouched."
