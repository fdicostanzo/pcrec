...
SAB_DOC_FIGURE="PREDICTED (§8.2): the cross-block cells of tests/utf8/fold.rxt section 1 and of axis06_caseless_fold.rxt go red; every ASCII cell stays green."
