...
SAB_DOC_FIGURE="tests/base/k66_precheck_whole_run.rxt is the answer-level detector: the two e...~#~#~#~# n cells and the two ...eeeeeeee!~#~#~#~# n cells of block 1 (byte) and the two ...eeeeeeee~# and two ...eeeeeeee!~#~#~#~# n cells of block 2 (utf8) fail as a steps give-up — corpus:8fail/8pass, the same 8 the pre-fix compiler (bbbf58e5) fails. tests/codegen/run_prechecks.sh section 5.8 reports the three rows expecting a whole-run compare finding none — prechecks:3fail/271pass. Exact re-run command: bash tests/mech/run_sabotage_matrix.sh S278."
