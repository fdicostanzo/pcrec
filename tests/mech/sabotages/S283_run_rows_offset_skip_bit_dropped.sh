...
SAB_DOC_FIGURE="tests/codegen/run_prechecks.sh §5.10 reports /user|/users [-fno-offset-skip] stamping run-pinned where memchr / none / emitted is expected. Exact re-run command: bash tests/mech/run_sabotage_matrix.sh S283."
