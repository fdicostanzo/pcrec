# S104 (design row S-BR2) — THE `caseless` FIELD IS IGNORED.
#
...
SAB_ID="S104-caseless-field-ignored"
...
SAB_DOC_FIGURE="PREDICTED: the corpus RED on caseless.rxt; codegen RED (the residbrefci fixture declares bref_match_caseless and the artifact would carry bref_match). Canonical figure owed from run_sabotage_matrix.sh S104."
SAB_COUNT=1
