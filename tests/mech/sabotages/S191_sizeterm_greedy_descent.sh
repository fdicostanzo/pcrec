...
SAB_DOC_FIGURE="PLACEHOLDER -- written 2026-08-29 (lane artsize3), CANONICAL RUN OWED (bash tests/mech/run_sabotage_matrix.sh S191). PREDICTED: sizeterm:>=1fail (§3's nested-N=8 cell reads a K that is not 1; §2's size-model cell may fire too), corpus:0fail on tests/size/size_term.rxt -- THE GREEN CORPUS ARM IS THE POINT OF THE ROW. Replace this line with the measured row and the arm figures."
