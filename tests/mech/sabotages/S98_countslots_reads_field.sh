...
SAB_COUNT=1
SAB_BEFORE='static void vm_count_slots_rep(Vm *v, const Ast *a, long long repl,
                               bool under_atomic)
{
    const bool cuts = vm_cuts(a, under_atomic);'
SAB_AFTER='static void vm_count_slots_rep(Vm *v, const Ast *a, long long repl,
                               bool under_atomic)
{
