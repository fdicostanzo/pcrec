...
SAB_DOC_FIGURE="tests/codegen/run_prechecks.sh §5.10 reports in|instanceof stamping run-pinned where offset-set / 0,1* / dominated is expected. Exact re-run command: bash tests/mech/run_sabotage_matrix.sh S281."
