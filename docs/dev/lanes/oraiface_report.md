...
| R56-6 (cons-F1, BLOCKING) | un-conflate the two owed items: S-U6/S-U9's closing witnesses are `match-at`-kind cells riding a LATER ladder rung (S-U9 ill-formed-subject; S-U6 WELL-FORMED — the find-all/empty-match boundary defect; distinction per r56verify); what uprops-first (Step 1) discharges is the STAGE-5 drift-zeroing 10.46 arm, S-U12's neighborhood | §0 (the charter summary) and §9 Step 1, both corrected in place with the S-U6/S-U9-vs-S-U12 distinction spelled out and cited to each row's own `sabotages/*.sh` header |
