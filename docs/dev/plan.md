...
- [M6.4] STATE:started (STARTED 2026-08-22, thirty-sixth session, on Frank's
  ...
  - [M6.4.3] STATE:started (AUTHORED 2026-08-22 11:4x on branch agd27 44ae045; CORRECTED 464ab1f after the first acceptance run — 15 corpus-side cells (features directive replaces std1; seven enabled-direction gating cells were vacuous perr pre-module; three lookaround cells commented out, module unbuilt), the miscompile cell UNTOUCHED; re-run vs main 69f3b93: 133/134, the one failure the miscompile; merges with the fix — 8 files / 113 patterns / 137 cells, oracle.py 137/137 reproduced by the manager, nothing in GOAL_FACTS found wrong; acceptance run against the merged module at [M6.4.2]'s merge review (69f3b93); cell agd27 created from main 59cbbda; allowlist docs/testing.md + docs/spec/match_api.md + the docs-side pcre2_ctypes.py + GOAL_FACTS.md = the approved design's Appendix B) — D27 BLINDED CORPUS (scripts/mk_d27_cell.sh;
