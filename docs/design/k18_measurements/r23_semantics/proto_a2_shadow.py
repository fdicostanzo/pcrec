...
src = src.replace('"K18STATS nfa=%d dfa=%d closures=%ld visits=%ld expansions=%ld "',
                  '"K18STATS scandiff=%ld ctxdiff=%ld clobber=%ld nfa=%d dfa=%d closures=%ld visits=%ld expansions=%ld "')
src = src.replace("nfa->n, d->n, k18_stats.closures,",
                  "k18_scan_diff, k18_ctx_diff, k18_clobber, nfa->n, d->n, k18_stats.closures,")
